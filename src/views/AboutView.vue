    ...
    return {
      ...
      tech: [
        ...
        },
        {
          id: 2,
          name: 'Instagram',
          imageUrl: 'https://uxwing.com/wp-content/themes/uxwing/download/brands-and-social-media/ig-instagram-icon.png',
          status: 'phghuy2007',
      ...
      <section class="text-sm md:text-lg text-justify flex flex-col gap-4 md:flex-row md:gap-8 md:justify-left md:items-center">
        <div class="flex justify-center">
          <img class="w-9/12 rounded-full mb-3 fadein-up"
            src="https://i.ibb.co/VpJYrnBW/Untitled-3.png" alt="Foto">
        </div>
        <div class="md:w-7/12">
